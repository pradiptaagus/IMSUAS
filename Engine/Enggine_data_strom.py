...
def uploadJson(local_file, dropbox_file):
	...
	file_path = pathlib.Path('E:/Dokument Semester 4/Integrasi dan Migrasi Sistem/Project Akhir/IMSUAS/File JSON/data_strom/' + local_file)
...
def downloadJson(target_file, local_file):
	try:
		...
		print(dl_url)
		dbx.files_download_to_file('E:/Dokument Semester 4/Integrasi dan Migrasi Sistem/Project Akhir/IMSUAS/File JSON/data_strom/' + local_file, '/' + target_file)
