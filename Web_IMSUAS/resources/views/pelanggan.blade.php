                    ...
                    @if(count($customers))
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    {{-- Edit --}}
                                    <button type="button" class="btn btn-primary btn-sm mr-1" data-toggle="modal" data-target="#updateModal{{$customer->id_pelanggan}}"><i class="fa fa-edit"></i></button>
                                    <!-- Modal -->
                                    ...
                                    {{-- Delete --}}
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$customer->id_pelanggan}}"><i class="fa fa-times"></i></button>
                                    <!-- Modal -->
